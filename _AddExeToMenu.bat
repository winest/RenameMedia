...
if ( true == WriteReg( "HKEY_CLASSES_ROOT\\AllFilesystemObjects\\shell\\RenameMedia\\Command\\" , "\"" + WshShell.CurrentDirectory + "\\Output\\RenameMedia\\RenameMedia.exe\" \"%1\"" , "REG_SZ" ) )
{
